...
class AbstractModel(ABC):
    ...
    def get_model_train_folder(self):
        return create_folder_if_not_exist(self.get_model_folder(), 'train')
    
    def get_model_val_folder(self):
        return create_folder_if_not_exist(self.get_model_folder(), 'val')
    
    def get_model_test_folder(self):
        return create_folder_if_not_exist(self.get_model_folder(), 'test')
