...
def create_spark_args():
    ...
    parser.add_argument('-fromEnd',
                        '--prediciton_window_fromEnd',
                        dest='prediciton_window_fromEnd',
                        action='store_true',
                        help='The set prediction window from end in which the prediction is made')
