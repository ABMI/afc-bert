...
class NestedCohortBuilder:
    def __init__(self,
                 ...
                 prediciton_window_fromEnd: bool = False,
        ...
        self._prediciton_window_fromEnd = prediciton_window_fromEnd
        ...
        self.get_logger().info(f'cohort_name: {cohort_name}\n'
                               ...
                               f'prediciton_window_fromEnd: {prediciton_window_fromEnd}\n'
    ...
    def build(self):
        ...
        prediciton_window_fromEnd = self._prediciton_window_fromEnd
        ...
        if self._is_prediction_window_unbounded:
            ...
            """
        if self._prediciton_window_fromEnd:
            query_template = """
            SELECT DISTINCT
                t.*,
                CAST(ISNOTNULL(o.person_id) AS INT) AS label
            ...
            LEFT JOIN global_temp.outcome_cohort AS o
                ON t.person_id = o.person_id
                    AND o.index_date BETWEEN DATE_ADD(t.index_date, {prediction_start_days}) 
                        AND DATE_ADD(t.cohort_end_date, {prediction_window})
...
def create_prediction_cohort(spark_args,
    ...
    prediciton_window_fromEnd = spark_args.prediciton_window_fromEnd
    ...
    NestedCohortBuilder(cohort_name=cohort_name,
                        ...
                        prediction_start_days=prediction_start_days,
                        prediciton_window_fromEnd=prediciton_window_fromEnd,
                        prediction_window=prediction_window,
